...
using StoreManagement.Controllers.Utils;
using StoreManagement.Data;
using StoreManagement.Models.Entities;
using StoreManagement.Models.ViewModel.Order;

namespace StoreManagement.Controllers;

public class OrderController(ApplicationDbContext _dbContext) : Controller
{
        ...
        decimal? priceTo = null)
    {
        ...
        var ordersList = await query
            ...
            .Select(o => new OrderViewTableModel
            {
                OrderId = o.OrderId,
        ...
        // Phân trang
        var pagedOrders = Pagination<OrderViewTableModel>.Create(ordersList, page, pageSize);
    ...
    public async Task<IActionResult> Detail(int id)
    {
        ...
        // Map sang viewModel
        var viewModel = new OrderViewDetailModel
        {
